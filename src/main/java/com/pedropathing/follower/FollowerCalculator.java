...
/**
 * This is the FollowerCalculator class. It handles all the on-the-fly
 ...
 */
@Config
public class FollowerCalculator {
    ...
    private FollowerVectors followerVectors;
    ...
    /**
     * This initializes the follower calculator.
        ...
        if (!teleopDrive) {
            if (currentPath != null) {
                if (holdingPosition) {
                    ...
                    followerVectors =
                            new FollowerVectors(MathFunctions.scalarMultiplyVector(getTranslationalCorrection(), holdPointTranslationalScaling),
                    ...
                    if (isBusy) {
                        ...
                        followerVectors = new FollowerVectors(
                                getCorrectiveVector(),
                                getHeadingVector(),
                                getDriveVector(),
                                poseUpdater.getPose().getHeading()
    ...
    /**
     * This gets the FollowerVectors object, calculated in the update
     * @return the FollowerVectors object
     */
    public FollowerVectors getFollowerVectors() {
        return followerVectors;
    }

    /**
     * This gets the drive powers from the drive vector scaler and the
     * current follower vectors
     * @return the drive powers, an array of 4 for each wheel
     */
    public double[] getDrivePowers() {
        return driveVectorScaler.getDrivePowers(
                followerVectors.correctiveVector,
                followerVectors.headingVector,
                followerVectors.pathingVector,
                followerVectors.robotHeading
        );
    }
    ...
    public void breakFollowing() {
        ...
        followerVectors = new FollowerVectors(new Vector(), new Vector(),
                new Vector(), 0);
    }
